...
public class TweetEditComplianceObjectSchema {
  ...
  private DmEventDataReferencedTweetsInner tweet;
  ...
  **/
  ...
  public TweetEditComplianceObjectSchema tweet(DmEventDataReferencedTweetsInner tweet) {
  ...
  **/
  ...
  public DmEventDataReferencedTweetsInner getTweet() {
    return tweet;
  }


  public void setTweet(DmEventDataReferencedTweetsInner tweet) {
    this.tweet = tweet;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TweetEditComplianceObjectSchema.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TweetEditComplianceObjectSchema` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      DmEventDataReferencedTweetsInner.validateJsonObject(jsonObj.getAsJsonObject("tweet"));
  }
